            ...
            <section id="about" data-aos="fade-down">
                <div>
                    ...
                    <div className="about-content">
                        ...
                        >
                            <p>
                                Hello, my name is Hernando. I'm born in August
                                25, 2004 in Indonesia which mean I can speak
                                Indonesia and little english. I'm currently work
                                as Full Stack Developer, and focus on developing
                ...
                <div data-aos="fade-right">
                    <div className="skills-container">
                        ...
                        <div className="education-list">
                            <h5>Programming</h5>
                            <p>
                                PHP, Javascript, Laravel, React Js, React Native
                            </p>
                        </div>
                        <div className="education-list">
